<%-- 
    Document   : menuhorario
    Created on : 11 dic. 2023, 11:31:49
    Author     : Jeampier
--%>
...
<html>
    ...
    <body>
        ...
        <div id="contenido">
            <!-- Código de la tabla de horarios -->
            <div class="menu2">
                <div class="col-md-7 mi-tabla pacientes">
                    <h3>Módulo de Horarios de Atención</h3>
                    <% ArrayList<Horario> hors = (ArrayList<Horario>) request.getAttribute("horarios"); %>
                    <table class="table" style="text-align:center">
                        <thead style="background:blue" >
                            
                            <tr >
                                <th scope="col" style="background:cornsilk;" >ID Horario</th>
                                <th scope="col" style="background:cornsilk;" >Inicio de cita</th>
                                <th scope="col" style="background:cornsilk;">Fin de la cita</th>
                        ...
                        <tbody>
                            <% for (Horario h : hors) {%>
                            <tr>
                                <th scope="row"> <%=h.getIdhorario()%> </th>
                                <td> <%=h.getHorarioinicio()%> </td>
                                <td> <%=h.getHorariofin()%> </td>
                                <td> </td>
                            </tr>
                            <%}%>
                        </tbody>
