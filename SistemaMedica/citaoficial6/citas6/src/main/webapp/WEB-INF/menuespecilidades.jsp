<%-- 
    Document   : menuespecilidades
    Created on : 11 dic. 2023, 11:24:07
    Author     : Jeampier
--%>
            ...
            <div class="menu2">
                <div class="col-md-7 mi-tabla pacientes">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col" style="background:cornsilk;">ID</th>
                                <th scope="col" style="background:cornsilk;">Especialidad</th>
                                <th scope="col" style="background:cornsilk;"></th>

                            </tr>
                        </thead>
                        <tbody>
                            <% for (Especialidad e : espes) {%>
                            <tr>
                                <th scope="row"> <%= e.getIdespecialidad()%> </th>
                                <td> <%= e.getNombre()%> </td>
                                <td></td>
                            </tr>
                            <%}%>
